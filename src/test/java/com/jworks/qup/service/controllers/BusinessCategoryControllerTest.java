...
import com.jworks.qup.service.providers.dto.BusinessCategoryDtoProvider;
...
public class BusinessCategoryControllerTest extends AbstractResourceTest {
    ...
    @Autowired
    private BusinessCategoryDtoProvider businessCategoryDtoProvider;
    ...
    public void testCreateBusinessCategory() throws Exception {
        BusinessCategoryDto dto = businessCategoryDtoProvider.provide();
